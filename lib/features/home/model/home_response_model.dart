...
class HomeData{
  ...
  factory HomeData.fromJson({required Map<String,dynamic> json}){
    return HomeData(
        homeBanners: (json["banners"] as
        List<dynamic>).map((e)=>HomeBanners.fromJson(json: e as Map<String,dynamic>)).toList(),
        homeProducts: (json["products"] as List<dynamic>).map((e)=>HomeProducts.fromJson (json: e as Map<String,dynamic>)).toList()
    );
  }
}
class HomeBanners{
